...
object DefaultUtil {
    ...
    /** 设置默认的铃声 */
    fun setRingDefault() {
        App.ring.startMusic = Music("assets/default_start.wav", "上课铃")
        App.ring.endMusic = Music("assets/default_end.wav", "下课铃")
        App.ring.graceMusic = Music("assets/amazing_grace.mp3", "赞美之歌")
    }
}